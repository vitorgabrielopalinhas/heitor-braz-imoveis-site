...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Depoimento/Chamada Emocional */}
      <section className="py-16 bg-gradient-to-r from-green-50 to-blue-50">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-4xl md:text-5xl font-bold text-gray-800 mb-8 leading-tight">
            🌟 Um novo começo com conforto, segurança e tranquilidade!
          </h3>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Realize o sonho da casa própria em um dos melhores programas habitacionais do país. 
            Sua família merece um lar seguro e aconchegante.
          </p>
        </div>
      </section>
